...
public class Test : MonoBehaviour
{
	private void Start()
	{
		...
		//KeyButtonUI.Create(() => Console.SendMessageToChat("nigga"), new Vector2(0, 0), new Vector2(300, 100), Color.white, "AFK", Color.black, KeyCode.LeftControl, KeyCode.LeftAlt, KeyCode.A);
		/*
